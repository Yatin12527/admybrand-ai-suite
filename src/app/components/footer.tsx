...
import { ArrowRight, Instagram, Twitter, Linkedin, Mail, Phone, MapPin, ExternalLink, Heart } from 'lucide-react';
      ...
      <div className="container mx-auto px-6 py-16">
        <div className="grid lg:grid-cols-5 md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
           <img src="/logo.svg"/>
            ...
            <p className="text-slate-400 text-base leading-relaxed mb-8 max-w-md">
              ...
              Join thousands of brands revolutionizing their approach.
            </p>

            {/* Social Icons */}
            <div className="flex items-center space-x-3">
              {[
                { icon: Twitter, label: "Twitter" ,link:"https://x.com/admybrand?lang=en"},
                { icon: Linkedin, label: "LinkedIn", link:"https://www.linkedin.com/company/admybrand?originalSubdomain=in" },
                { icon: Instagram, label: "Instagram",link:"https://www.instagram.com/Admybrand" }
              ].map((social) => (
                <a
                  key={social.label}
                  href={social.link}
          ...
          <div>
            ...
            {/* Newsletter */}
            <div>
              <p className="text-slate-400 text-xs mb-3 uppercase tracking-wide">Newsletter</p>
              <div className="flex">
                <input 
                  type="email" 
